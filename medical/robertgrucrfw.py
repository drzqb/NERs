...
from tensorflow.keras.layers import Input, Layer, Dense, Embedding, LayerNormalization, Dropout, Bidirectional, GRU
...
parser.add_argument('--per_save', type=int, default=7036 // 8, help='steps per epoch')
parser.add_argument('--decay_steps', type=int, default=10 * (7036 // 8), help='decay steps')
parser.add_argument('--warmup_steps', type=int, default=1 * (7036 // 8), help='warmup steps')
...
parser.add_argument('--check', type=str, default='model/medical_robertbigrucrfw',
...
class USER():
    def build_model(self):
        ...
        predict = CRF(label_dim=params.label_dim, name="crf")(inputs=(gruoutput, lab, sumls))
