'''
    tinybert + crf for medical ner with tf2.0
...
parser.add_argument('--check', type=str, default='model/medical_tinybertcrf',
...
class USER:
    ...
    def plothistory(self):
        ...
        plt.tight_layout()
        plt.savefig("tinybertcrf_PRF.jpg", dpi=500, bbox_inches="tight")
