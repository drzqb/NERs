...
parser.add_argument('--check', type=str, default='model/mrc_span_tiny', help='The path where model saved')
...
class USER:
    ...
    def plothistory(self):
        ...
        plt.tight_layout()
        plt.savefig("mrc_span_tiny_PRF.jpg", dpi=500, bbox_inches="tight")
